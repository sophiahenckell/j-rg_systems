...
ASPECT_RATIO=0
BROWNIAN_TIMESTEP=0.005 
SAVING_TIMESTEP=0.001 
SWELLING_RATE=0
NAME="Figure4_7_LangeErik${RUN_ID}T${SIMULATION_TIME}N${PARTICLE_NUMBER}k${ASPECT_RATIO//.}Phi${PACKING_FRACTION//.}"
DATA="/data/scc/sophia/Figure4_7_MSD${RUN_ID}-n${PARTICLE_NUMBER}-t${SIMULATION_TIME}-phi${PACKING_FRACTION}-k${ASPECT_RATIO}-tb${BROWNIAN_TIMESTEP}-ts${SAVING_TIMESTEP}"
mkdir -p $DATA/logs
